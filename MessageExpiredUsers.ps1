...
$users = Get-ADUser -Server $adDomain -filter * -SearchBase $adSearchBase -properties Name, PasswordNeverExpires, PasswordExpired, PasswordLastSet, EmailAddress, SID -Credential $adCredential `
